...
public class SwaggerConfig {
	...
	public Docket detalheApi() {
		...
		.select()
		.apis(RequestHandlerSelectors.basePackage("br.com.petz.controller"))
	...
	private ApiInfoBuilder informacoesApi() {
		...
		apiInfoBuilder.title("Backend Test Petz");
		apiInfoBuilder.description("Backend Test Petz");
		apiInfoBuilder.version("1.0.0");
		apiInfoBuilder.licenseUrl("www.linkedin.com/in/brunofreis");
	...
	private Contact contato() {
		...
		return new Contact(
				"Bruno Fernandes",
				"www.linkedin.com/in/brunofreis", 
